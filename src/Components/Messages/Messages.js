                ...
                return (
                    <Row style={{ width: '100%' }} key={msg.time}>
                        <div className={`msg ${(msg.userID === userId) ? 'my-msg' : ''}`}>
                            ...
                            <Button style={{ display: msg.userID === userId ? '' : 'none', backgroundColor: 'transparent', border: 'none', float: 'right' }} onClick={(e) => props.delMsg(msg)}><i className='fa fa-trash'></i></Button>
